...
export default function CreateAccountPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 font-serif pt-28 pb-20 max-w-4xl mx-auto px-6">
      ...
      {errorMessage && (
        <div className="bg-red-50 border border-red-200 text-red-800 text-xs p-3 mb-6 max-w-2xl mx-auto">
          {errorMessage}
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        <form onSubmit={handleSubmit} className="md:col-span-2 space-y-8">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-neutral-900 text-white text-xs tracking-[0.2em] uppercase hover:bg-neutral-800 transition-colors disabled:opacity-50"
          >
        ...
        <div className="bg-neutral-50 p-6 border border-neutral-200 h-fit space-y-3">
          ...
          <p className="text-xs text-neutral-600 font-light leading-relaxed">
            In addition to easing your ordering process, creating an account will allow you to save history of your orders, register more than one delivery address, and follow your shipping.
          </p>
        </div>
      </div>
    </div>
