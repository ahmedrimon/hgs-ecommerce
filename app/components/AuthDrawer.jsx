    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-white h-full shadow-2xl p-8 overflow-y-auto flex flex-col justify-between z-10 font-serif">
        <div>
          ...
          {errorMessage && (
            <div className="bg-red-50 border border-red-200 text-red-800 text-xs p-3 mb-4">
              {errorMessage}
            </div>
          )}
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            ...
            <div className="flex justify-between items-center pt-2">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-6 py-2.5 bg-neutral-900 text-white text-xs tracking-widest uppercase hover:bg-neutral-800 transition-colors disabled:opacity-50"
              >
