...
//   return (
//     <>
//       <header className="fixed top-0 left-0 right-0 z-40 bg-white/90 backdrop-blur-md border-b border-neutral-100 font-serif">
//         <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          
//           <div className="flex items-center space-x-6">
//             <button className="text-xs uppercase tracking-[0.2em] font-medium text-neutral-800">
//               Menu
//             </button>
//           </div>
...
//             <Link href="/">
//               <h1 className="text-xl md:text-2xl font-serif tracking-[0.35em] text-neutral-900 uppercase">
//                 TRVDON
//               </h1>
//               <p className="text-[10px] tracking-[0.3em] text-neutral-500 font-light -mt-1">
//                 .1643.
//               </p>
//             </Link>
//           </div>
...
//             <button onClick={() => setIsSearchOpen(true)} className="p-1 hover:text-neutral-500">
